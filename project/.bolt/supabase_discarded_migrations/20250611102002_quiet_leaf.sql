/*
  ...
  1. Billboard Types
    - Add comprehensive billboard types with descriptions
    - Enable admin management of billboard types

  2. Sample Data
    - Add sample billboards in different workflow states
    - Add billboard images for samples
    - Add notifications for workflow demonstration
    - Add site visit records

  3. Workflow States
    - pending: Submitted by owner, awaiting admin review
    - approved: Approved by admin, awaiting sub-admin verification
    - active: Verified and activated, visible on platform
*/
